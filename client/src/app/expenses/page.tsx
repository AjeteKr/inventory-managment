...
type AggregatedData = { [category: string]: AggregatedDataItem; };
...
const Expenses = () => {
    ...
    const classNames = {
        label: "block text-sm font-medium !text-gray-700 dark:!text-gray-500",
        selectInput: "mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md dark:border-gray-600 dark:bg-gray-300 dark:text-gray-900 dark:focus:ring-indigo-500 dark:focus:border-indigo-500",
    };
    ...
    return (
        <div>
            ...
            <div className="mb-5">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400"> A visual representation of expenses over time. </p>
            </div>
            {/* FILTERS */}
            <div className="flex flex-col md:flex-row justify-between gap-4">
                <div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6 dark:bg-gray-000">
                    ...
                    <div className="space-y-4 text-lg">
                        ...
                        <div>
                            ...
                            <input type="date" id="start-date" name="start-date" className={classNames.selectInput} onChange={handleStartDateChange} max={today} />
                        </div>
                        {/* END DATE */}
                        <div>
                            <label htmlFor="end-date" className={classNames.label}> End Date </label>
                            <input type="date" id="end-date" name="end-date" className={classNames.selectInput} onChange={handleEndDateChange} max={today} />
                        </div>
                    </div>
                </div>
                {/* PIE CHART */}
                <div className="flex-grow bg-white shadow rounded-lg p-4 md:p-6 dark:bg-gray-0">
